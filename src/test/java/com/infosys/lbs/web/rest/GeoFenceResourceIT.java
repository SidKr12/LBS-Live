...
public class GeoFenceResourceIT {
    ...
    private static final LocalDate DEFAULT_MODIFIED_TIME = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_MODIFIED_TIME = LocalDate.now(ZoneId.systemDefault());
